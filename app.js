...
function subscribeRealtime(){if(!isConfigured)return;sbClient.channel('kanban_changes').on('postgres_changes',{event:'*',schema:'public',table:'kanban_items'},()=>loadData()).subscribe();}
